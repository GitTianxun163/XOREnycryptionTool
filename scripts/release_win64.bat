...
echo Linking
g++ build/Application.o build/main.o build/moc_*.cpp build/rc.o bin/win64/enycpt.dll %QT_HOME%/lib/*.a -I %QT_HOME%/include -o bin/win64/enycpt.UI.exe -Wl,--subsystem,windows
